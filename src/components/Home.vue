<template>
  <div>
    <!-- <video  muted width="100%" controls src="http://iandevlin.github.io/mdn/video-player/video/tears-of-steel-battle-clip-medium.mp4"></video> -->
    <section class="showcase">
      <header>
        <h2 class="logo">SK Bike Service Center</h2>
        <div class="toggle" @click="OpenSlider"></div>
      </header>
      <video muted loop autoplay width="100" src="../assets/nature.mp4"></video>
